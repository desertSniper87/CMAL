...
def train(nb_epoch, batch_size, store_name, resume=False, start_epoch=0, model_path=None, data_path = ''):
    ...
    net = Network_Wrapper(net_layers, 1000)
...
if __name__ == '__main__':
    ...
    data_path = '/Users/bccca/dev/dat/personai_icartoonface_rectrain/icartoonface_rectrain_split'
    os.environ["CUDA_VISIBLE_DEVICES"] = "0"
    train(nb_epoch=200,             # number of epoch
             batch_size=16,         # batch size
             store_name='Results_iCartoonFace_ResNet50',     # folder for output
